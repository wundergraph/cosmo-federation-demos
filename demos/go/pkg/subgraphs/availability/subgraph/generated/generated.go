...
import (
	...
	"github.com/wundergraph/cosmo-federation-demos/demos/go/pkg/subgraphs/availability/subgraph/model"
)
...
type ComplexityRoot struct {
	...
	Mutation struct {
		UpdateAvailability func(childComplexity int, employeeID int, isAvailable bool) int
	}
...
type MutationResolver interface {
	UpdateAvailability(ctx context.Context, employeeID int, isAvailable bool) (*model.Employee, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.updateAvailability":
		...
		args, err := ec.field_Mutation_updateAvailability_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.UpdateAvailability(childComplexity, args["employeeID"].(int), args["isAvailable"].(bool)), true
...
func (ec *executionContext) field_Mutation_updateAvailability_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 int
...
func (ec *executionContext) _Entity_findEmployeeByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNEmployee2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋavailabilityᚋsubgraphᚋmodelᚐEmployee(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateAvailability(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_updateAvailability(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateAvailability(rctx, fc.Args["employeeID"].(int), fc.Args["isAvailable"].(bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) marshalNEmployee2githubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋavailabilityᚋsubgraphᚋmodelᚐEmployee(ctx context.Context, sel ast.SelectionSet, v model.Employee) graphql.Marshaler {
	return ec._Employee(ctx, sel, &v)
}

func (ec *executionContext) marshalNEmployee2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋavailabilityᚋsubgraphᚋmodelᚐEmployee(ctx context.Context, sel ast.SelectionSet, v *model.Employee) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
