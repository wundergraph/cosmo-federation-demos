...
type ComplexityRoot struct {
	...
	Mutation struct {
		UpdateMood func(childComplexity int, employeeID int, mood model.Mood) int
	}
...
type MutationResolver interface {
	UpdateMood(ctx context.Context, employeeID int, mood model.Mood) (*model.Employee, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.updateMood":
		...
		return e.complexity.Mutation.UpdateMood(childComplexity, args["employeeID"].(int), args["mood"].(model.Mood)), true
...
func (ec *executionContext) field_Mutation_updateMood_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["mood"]; ok {
		...
		arg1, err = ec.unmarshalNMood2githubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋmoodᚋsubgraphᚋmodelᚐMood(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Employee_currentMood(ctx context.Context, field graphql.CollectedField, obj *model.Employee) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMood2githubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋmoodᚋsubgraphᚋmodelᚐMood(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Entity_findEmployeeByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNEmployee2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋmoodᚋsubgraphᚋmodelᚐEmployee(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateMood(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateMood(rctx, fc.Args["employeeID"].(int), fc.Args["mood"].(model.Mood))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) marshalNEmployee2githubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋmoodᚋsubgraphᚋmodelᚐEmployee(ctx context.Context, sel ast.SelectionSet, v model.Employee) graphql.Marshaler {
	return ec._Employee(ctx, sel, &v)
}

func (ec *executionContext) marshalNEmployee2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋmoodᚋsubgraphᚋmodelᚐEmployee(ctx context.Context, sel ast.SelectionSet, v *model.Employee) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNMood2githubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋmoodᚋsubgraphᚋmodelᚐMood(ctx context.Context, v interface{}) (model.Mood, error) {
	var res model.Mood
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNMood2githubᚗcomᚋwundergraphᚋcosmoᚑfederationᚑdemosᚋdemosᚋgoᚋpkgᚋsubgraphsᚋmoodᚋsubgraphᚋmodelᚐMood(ctx context.Context, sel ast.SelectionSet, v model.Mood) graphql.Marshaler {
	return v
}
